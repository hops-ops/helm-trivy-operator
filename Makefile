...
PACKAGE ?= helm-trivy-operator
XRD_DIR := apis/trivyoperators
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/trivyoperators/standard.yaml
...
EXAMPLES := \
    examples/trivyoperators/minimal.yaml:: \
    examples/trivyoperators/standard.yaml::
...
render\:%:
	@example="examples/trivyoperators/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
